                ...
                <div class="global-prices-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 16px;">
                    ...
                    <div class="global-price-card" style="background: var(--surface); padding: 16px; border-radius: var(--radius-lg); border: 1px solid var(--surface-border);">
                        ...
                        <input type="number" id="globalPriceMales" class="form-control global-price-input" data-category="males" 
                               ...
                               min="0" step="100" placeholder="25000" style="font-weight: 600; font-size: 16px; border-color: #3B82F6;">
                    ...
                    <div class="global-price-card" style="background: var(--surface); padding: 16px; border-radius: var(--radius-lg); border: 1px solid var(--surface-border);">
                        ...
                        <input type="number" id="globalPriceFemales" class="form-control global-price-input" data-category="females" 
                               ...
                               min="0" step="100" placeholder="30000" style="font-weight: 600; font-size: 16px; border-color: #EC4899;">
                        <small style="color: var(--text-tertiary); font-size: 11px; margin-top: 4px; display: block;">
                    ...
                    <div class="global-price-card" style="background: var(--surface); padding: 16px; border-radius: var(--radius-lg); border: 1px solid var(--surface-border);">
                        ...
                        <input type="number" id="globalPriceLapereaux" class="form-control global-price-input" data-category="lapereaux" 
                               ...
                               min="0" step="100" placeholder="15000" style="font-weight: 600; font-size: 16px; border-color: #10B981;">
                        <small style="color: var(--text-tertiary); font-size: 11px; margin-top: 4px; display: block;">
            ...
            <div class="form-section" style="margin-top: 24px; border: 2px solid var(--primary-subtle);">
                ...
                <div class="tabs-container" style="margin-bottom: 20px;">
                    <button type="button" class="tab-btn active" data-tab="males-tab">
                        <i class="bi bi-arrow-up-right-square"></i> Mâles (<span id="malesCount">{{ $totalCounts['males'] ?? 0 }}</span>)
                    </button>
                    <button type="button" class="tab-btn" data-tab="females-tab">
                        <i class="bi bi-arrow-down-right-square"></i> Femelles (<span id="femalesCount">{{ $totalCounts['females'] ?? 0 }}</span>)
                    </button>
                    <button type="button" class="tab-btn" data-tab="lapereaux-tab">
                        <i class="bi bi-egg-fill"></i> Lapereaux (<span id="lapereauxCount">{{ $totalCounts['lapereaux'] ?? 0 }}</span>)
                    </button>
                </div>
                ...
                <div class="tab-content active" id="males-tab">
                    <div style="display: flex; gap: 12px; margin-bottom: 16px; flex-wrap: wrap;">
                        <input type="text" class="form-control" placeholder="Rechercher un mâle..." id="searchMales" 
                               style="flex: 1; min-width: 250px;" onkeyup="debouncedSearch('males', this.value)">
                    ...
                    <div class="pagination-info" id="malesPaginationInfo" style="margin-top: 16px; text-align: center; color: var(--text-tertiary); font-size: 13px;">
                        Page {{ $males->currentPage() }} sur {{ $males->lastPage() }} ({{ $totalCounts['males'] ?? $males->total() }} mâles au total)
                    </div>
                </div>
                ...
                <div class="tab-content" id="females-tab">
                    <div style="display: flex; gap: 12px; margin-bottom: 16px; flex-wrap: wrap;">
                        <input type="text" class="form-control" placeholder="Rechercher une femelle..." id="searchFemales" 
                               style="flex: 1; min-width: 250px;" onkeyup="debouncedSearch('females', this.value)">
                    ...
                    <div class="pagination-info" id="femalesPaginationInfo" style="margin-top: 16px; text-align: center; color: var(--text-tertiary); font-size: 13px;">
                        Page {{ $femelles->currentPage() }} sur {{ $femelles->lastPage() }} ({{ $totalCounts['females'] ?? $femelles->total() }} femelles au total)
                    </div>
                </div>
                ...
                <div class="tab-content" id="lapereaux-tab">
                    <div style="display: flex; gap: 12px; margin-bottom: 16px; flex-wrap: wrap;">
                        <input type="text" class="form-control" placeholder="Rechercher un lapereau..." id="searchLapereaux" 
                               style="flex: 1; min-width: 250px;" onkeyup="debouncedSearch('lapereaux', this.value)">
                    ...
                    <div class="pagination-info" id="lapereauxPaginationInfo" style="margin-top: 16px; text-align: center; color: var(--text-tertiary); font-size: 13px;">
                        Page {{ $lapereaux->currentPage() }} sur {{ $lapereaux->lastPage() }} ({{ $totalCounts['lapereaux'] ?? $lapereaux->total() }} lapereaux au total)
                    </div>
                </div>
    ...
    function loadRabbits(type, page = 1, search = '') {
        ...
        .then(data => {
            if (data.success) {
                ...
                if (paginationInfo) {
                    // ✅ Show total count from database, not just page
                    const totalCount = data.total_count || data.pagination.total;
                    paginationInfo.innerHTML = `Page ${data.pagination.current_page} sur ${data.pagination.last_page} (${totalCount} ${type} au total)`;
                }
