                ...
                <div class="settings-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="buyer_contact" class="form-control" 
                               value="{{ old('buyer_contact', $sale->buyer_contact) }}" 
                               placeholder="Téléphone ou email">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Adresse</label>
                        <textarea name="buyer_address" class="form-control" rows="2" 
                                  placeholder="Adresse complète">{{ old('buyer_address', $sale->buyer_address) }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="rabbit-selection-grid" id="malesGrid" 
                        ...
                        <label class="rabbit-card" style="display: flex; flex-direction: column; gap: 8px; padding: 12px; background: var(--surface-alt); border: 1px solid var(--surface-border); border-radius: var(--radius); cursor: pointer; transition: all 0.2s ease;">
                            ...
                            <div class="price-input-container" id="price-males-{{ $male->id }}" 
                                ...
                                @php
                                    $saleRabbit = $sale->rabbits()->where('rabbit_type', 'male')->where('rabbit_id', $male->id)->first();
                    ...
                    <div class="rabbit-selection-grid" id="femalesGrid" 
                        ...
                        <label class="rabbit-card" style="display: flex; flex-direction: column; gap: 8px; padding: 12px; background: var(--surface-alt); border: 1px solid var(--surface-border); border-radius: var(--radius); cursor: pointer; transition: all 0.2s ease;">
                            ...
                            <div class="price-input-container" id="price-females-{{ $femelle->id }}" 
                                ...
                                @php
                                    $saleRabbit = $sale->rabbits()->where('rabbit_type', 'female')->where('rabbit_id', $femelle->id)->first();
                                    $existingPrice = $saleRabbit?->sale_price ?? 0;
                                @endphp
                        ...
                        <label class="rabbit-card" style="display: flex; flex-direction: column; gap: 8px; padding: 12px; background: var(--surface-alt); border: 1px solid var(--surface-border); border-radius: var(--radius); cursor: pointer; transition: all 0.2s ease;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <input type="checkbox" name="selected_lapereaux[]" value="{{ $lapereau->id }}" 
                                       ...
                                       data-code="{{ $lapereau->code }}" data-name="{{ $lapereau->nom ?? 'Sans nom' }}" 
                            ...
                            <div class="price-input-container" id="price-lapereaux-{{ $lapereau->id }}" 
                                ...
                                @php
                                    $saleRabbit = $sale->rabbits()->where('rabbit_type', 'lapereau')->where('rabbit_id', $lapereau->id)->first();
                                    $existingPrice = $saleRabbit?->sale_price ?? 0;
                                @endphp
                ...
                <div style="margin-top: 24px; padding: 16px; background: var(--primary-subtle); border-radius: var(--radius-lg);">
                    ...
                    <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid var(--surface-border);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="totalAmountDisplay" style="font-size: 20px; font-weight: 700; color: var(--primary);">
                                0 FCFA
                            </span>
                        </div>
                    </div>
            ...
            <div class="form-section" style="margin-top: 24px;">
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" class="form-control" rows="3" 
                              placeholder="Informations complémentaires...">{{ old('notes', $sale->notes) }}</textarea>
                </div>
            </div>
