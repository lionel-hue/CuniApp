...
@section('content')
                            ...
                            <div class="form-group">
                                ...
                                <select name="etat_sante" class="form-select" required>
                                    <option value="Excellent" {{ old('etat_sante') == 'Excellent' ? 'selected' : '' }}>
                                        Excellent</option>
                                    <option value="Bon"
                                        {{ old('etat_sante') == 'Bon' || !old('etat_sante') ? 'selected' : '' }}>Bon
                                    </option>
                                    <option value="Moyen" {{ old('etat_sante') == 'Moyen' ? 'selected' : '' }}>Moyen
                                    </option>
    ...
    <style>
        .page-content-min {
            ...
            /* Ajustez selon hauteur header+footer */
            padding-bottom: 40px;
        }
