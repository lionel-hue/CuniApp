        ...
        <form action="{{ route('sales.store') }}" method="POST" id="saleForm">
            ...
            <div class="form-section" style="margin-top: 24px; border: 2px solid var(--primary-subtle); background: linear-gradient(135deg, var(--primary-subtle) 0%, var(--surface-alt) 100%);">
                ...
                <div class="alert-box info" style="margin-bottom: 16px;">
                    ...
                    <div>
                        <strong>💡 Astuce:</strong> Définissez un prix par défaut pour chaque catégorie. Ce prix sera automatiquement appliqué à tous les lapins sélectionnés.
                ...
                <div class="global-prices-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 16px;">
                    ...
                    <div class="global-price-card" style="background: var(--surface); padding: 16px; border-radius: var(--radius-lg); border: 1px solid var(--surface-border);">
                        ...
                        <input type="number" id="globalPriceMales" class="form-control global-price-input" data-category="males" 
                    ...
                    <div class="global-price-card" style="background: var(--surface); padding: 16px; border-radius: var(--radius-lg); border: 1px solid var(--surface-border);">
                        ...
                        <input type="number" id="globalPriceFemales" class="form-control global-price-input" data-category="females" 
                    ...
                    <div class="global-price-card" style="background: var(--surface); padding: 16px; border-radius: var(--radius-lg); border: 1px solid var(--surface-border);">
                        ...
                        <input type="number" id="globalPriceLapereaux" class="form-control global-price-input" data-category="lapereaux" 
            ...
            <div class="form-section" style="margin-top: 24px; border: 2px solid var(--primary-subtle);">
                ...
                <div class="tab-content active" id="males-tab">
                    ...
                    <div class="rabbit-selection-grid" id="malesGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 12px;">
                        ...
                        <label class="rabbit-card" style="display: flex; flex-direction: column; gap: 8px; padding: 12px; background: var(--surface-alt); border: 1px solid var(--surface-border); border-radius: var(--radius); cursor: pointer; transition: all 0.2s ease;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <input type="checkbox" name="selected_males[]" value="{{ $male->id }}" class="rabbit-checkbox" data-category="males" data-code="{{ $male->code }}" data-name="{{ $male->nom }}" onchange="handleRabbitSelection('males', {{ $male->id }})">
                                <div style="flex: 1;">
                            ...
                            <div class="price-input-container" id="price-males-{{ $male->id }}" style="display: none; margin-top: 8px;">
                                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
                                    <label style="font-size: 11px; color: var(--text-secondary); flex: 1;">Prix individuel (FCFA)</label>
                                    <button type="button" class="btn-reset-price" onclick="resetToGlobalPrice('males', {{ $male->id }})" title="Réinitialiser au prix global" style="background: var(--primary-subtle); border: none; border-radius: 4px; padding: 4px 8px; font-size: 10px; color: var(--primary); cursor: pointer;">
                                        <i class="bi bi-arrow-counterclockwise"></i> Prix global
                                    </button>
                                </div>
                                <input type="number" name="male_prices[]" class="form-control rabbit-price" data-category="males" data-rabbit-id="{{ $male->id }}" placeholder="0" min="0" step="100" onchange="calculateTotalAmount(); markPriceAsCustom('males', {{ $male->id }})" style="padding: 8px; font-size: 13px;">
                                <div class="price-indicator" id="price-indicator-males-{{ $male->id }}" style="font-size: 10px; color: var(--accent-green); margin-top: 4px; display: none;">
                ...
                <div class="tab-content" id="females-tab">
                    ...
                    <div class="rabbit-selection-grid" id="femalesGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 12px;">
                        ...
                        <label class="rabbit-card" style="display: flex; flex-direction: column; gap: 8px; padding: 12px; background: var(--surface-alt); border: 1px solid var(--surface-border); border-radius: var(--radius); cursor: pointer; transition: all 0.2s ease;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <input type="checkbox" name="selected_females[]" value="{{ $femelle->id }}" class="rabbit-checkbox" data-category="females" data-code="{{ $femelle->code }}" data-name="{{ $femelle->nom }}" onchange="handleRabbitSelection('females', {{ $femelle->id }})">
                                <div style="flex: 1;">
                            ...
                            {{-- ✅ Individual Price Input with Global Indicator --}}
                            <div class="price-input-container" id="price-females-{{ $femelle->id }}" style="display: none; margin-top: 8px;">
                                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
                                    <label style="font-size: 11px; color: var(--text-secondary); flex: 1;">Prix individuel (FCFA)</label>
                                    <button type="button" class="btn-reset-price" onclick="resetToGlobalPrice('females', {{ $femelle->id }})" title="Réinitialiser au prix global" style="background: var(--primary-subtle); border: none; border-radius: 4px; padding: 4px 8px; font-size: 10px; color: var(--primary); cursor: pointer;">
                                        <i class="bi bi-arrow-counterclockwise"></i> Prix global
                                    </button>
                                </div>
                                <input type="number" name="female_prices[]" class="form-control rabbit-price" data-category="females" data-rabbit-id="{{ $femelle->id }}" placeholder="0" min="0" step="100" onchange="calculateTotalAmount(); markPriceAsCustom('females', {{ $femelle->id }})" style="padding: 8px; font-size: 13px;">
                                <div class="price-indicator" id="price-indicator-females-{{ $femelle->id }}" style="font-size: 10px; color: var(--accent-green); margin-top: 4px; display: none;">
                                    <i class="bi bi-check-circle"></i> Prix global appliqué
                                </div>
                            </div>
                        </label>
                ...
                <div class="tab-content" id="lapereaux-tab">
                    ...
                    <div class="rabbit-selection-grid" id="lapereauxGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 12px;">
                        ...
                        <label class="rabbit-card" style="display: flex; flex-direction: column; gap: 8px; padding: 12px; background: var(--surface-alt); border: 1px solid var(--surface-border); border-radius: var(--radius); cursor: pointer; transition: all 0.2s ease;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <input type="checkbox" name="selected_lapereaux[]" value="{{ $lapereau->id }}" class="rabbit-checkbox" data-category="lapereaux" data-code="{{ $lapereau->code }}" data-name="{{ $lapereau->nom ?? 'Sans nom' }}" onchange="handleRabbitSelection('lapereaux', {{ $lapereau->id }})">
                                <div style="flex: 1;">
                                    <div style="font-weight: 600;">{{ $lapereau->nom ?? 'Sans nom' }}</div>
                                    <div style="font-size: 12px; color: var(--text-tertiary);">
                                        {{ $lapereau->code }} • {{ $lapereau->naissance->miseBas->femelle->nom ?? 'N/A' }}
                                    </div>
                                </div>
                            </div>
                            {{-- ✅ Individual Price Input with Global Indicator --}}
                            <div class="price-input-container" id="price-lapereaux-{{ $lapereau->id }}" style="display: none; margin-top: 8px;">
                                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
                                    <label style="font-size: 11px; color: var(--text-secondary); flex: 1;">Prix individuel (FCFA)</label>
                                    <button type="button" class="btn-reset-price" onclick="resetToGlobalPrice('lapereaux', {{ $lapereau->id }})" title="Réinitialiser au prix global" style="background: var(--primary-subtle); border: none; border-radius: 4px; padding: 4px 8px; font-size: 10px; color: var(--primary); cursor: pointer;">
                                        <i class="bi bi-arrow-counterclockwise"></i> Prix global
                                    </button>
                                </div>
                                <input type="number" name="lapereau_prices[]" class="form-control rabbit-price" data-category="lapereaux" data-rabbit-id="{{ $lapereau->id }}" placeholder="0" min="0" step="100" onchange="calculateTotalAmount(); markPriceAsCustom('lapereaux', {{ $lapereau->id }})" style="padding: 8px; font-size: 13px;">
                                <div class="price-indicator" id="price-indicator-lapereaux-{{ $lapereau->id }}" style="font-size: 10px; color: var(--accent-green); margin-top: 4px; display: none;">
                                    <i class="bi bi-check-circle"></i> Prix global appliqué
                                </div>
                            </div>
                        </label>
...
// Handle rabbit selection with auto-price
function handleRabbitSelection(category, rabbitId) {
    ...
    if (checkbox && priceContainer) {
        ...
        if (checkbox.checked && priceInput) {
            // Check if we have a custom price saved
...
function calculateTotalAmount() {
    ...
    document.getElementById('totalAmountDisplay').textContent = 
        total.toLocaleString('fr-FR', { minimumFractionDigits: 0, maximumFractionDigits: 0 }) + ' FCFA';
