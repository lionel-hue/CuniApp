                        ...
                        <td class="pe-4">
                            <div class="action-buttons">
                                ...
                                <form action="{{ route('sales.mark-paid', $sale) }}" method="POST" style="display:inline;">
                                    @csrf
                                    <button type="submit" class="btn-cuni sm primary" title="Marquer comme payé" onclick="return confirm('Marquer cette vente comme payée ?')">
                                ...
                                <form action="{{ route('sales.destroy', $sale) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn-cuni sm danger" title="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette vente ?')">
